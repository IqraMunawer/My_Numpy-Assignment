...
def function2():
    ...
    x = np.arange(10,37, dtype = np.float64)
    x.reshape(3,3,3)
    return x                #wrtie your code here # completed
...
def function4():
    ...
    return  arr#wrtie your code here    # completed
    """
    Expected Output:
          array([[1, 0, 2],
                [4, 3, 5],
...
def function5():
    ...
    z = np.zeros(20, dtype = int).reshape(4,5)#wrtie your code here     #completed
    return z
    """
    Expected Output:
          array([[0, 0, 0, 0, 0],
...
def function6():
    ...
    arr =  np.zeros(10)
    arr[5] = 10
    arr[8]= 20 #wrtie your code here          #completed
...
def function7():
    ...
    return x #write your code here      #completed
...
def function8():
    ...
    x = np.full((2, 5), 6, dtype=np.uint)#write your code here     #completed
...
def function9():
    ...
    a = np.arange(2,102,2) # write your code here   #completed
...
def function10():
    ...
    brr = np.array([1,2,3])
    brr = np.vstack(brr)
    subt = np.subtract(arr , brr)  # write your code here  #completed
...
def function12():
    ...
    arr = np.array([1,2,3])
    ans = np.hstack([arr[0],arr[0],arr[0],arr[1],arr[1],arr[1],arr[2],arr[2],arr[2],arr,arr,arr])    #write your code here 
...
def function13():
    ...
    ans = arr[np.where((arr > 5) & (arr < 10))]   #write your code here     #completed
...
def function14():
    ...
    ans = np.split(arr, 4) #write your code here        #completed
    return ans
...
def function15():
    ...
    ans =  arr[arr[:,1].argsort()]#write your code here        #completed
...
def function16():
    ...
    x = np.array([[1], [2], [3]])
    y = np.array([[2], [3], [4]])
    ans = np.dstack((x,y))#write your code here          #completed
...
def function17():
    ...
    return arr         # Write Your Code HERE              #completed
...
def function18():
    ...
    for j in students:
        for i in piaic:
            if j == i:
                x= x+1     # Write you code Here       #completed
    return x
...
def function19():
    ...
    output =  (X*W)+b  # Write your code here    #completed
    return output
    #expected output      
    """
...
def fucntion20():
    ...
    return xyz(x)#Write your Code here           #completed
